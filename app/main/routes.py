...
BUCKET_NAME = "daodaotext-data"  # GCSのバケット名
...
def upload_to_gcs(file, destination_filename):
    """GCSにファイルをアップロード"""
...
def add():
    if request.method == 'POST':
        ...
        pdf_url = upload_to_gcs(pdf_file, f"uploads/{pdf_filename}")
        png_url = upload_to_gcs(png_file, f"uploads/{png_filename}")
