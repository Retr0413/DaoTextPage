...
def seed_data():
    ...
    if not Text.query.first():  
        sample_texts = [
            {"title": "クローラー", "pdf_path": "uploads/星1クローラー.pdf", "text_png" : "uploads/クローラー.png", "context": "クローラーの内容", "stars": 1},
            {"title": "ロボットハンド", "pdf_path": "uploads/星1ロボットハンド.pdf", "text_png" : "uploads/ロボットハンド.png", "context": "ロボットハンドの内容", "stars": 1},
            {"title": "ターンテーブル", "pdf_path": "uploads/星1ターンテーブル.pdf", "text_png" : "uploads/ターンテーブル.png", "context": "ターンテーブルの内容", "stars": 1},
            {"title": "たじたじくん", "pdf_path": "uploads/星1たじたじくん.pdf", "text_png" : "uploads/たじたじくん.png", "context": "たじたじくんの内容", "stars": 1},
            {"title": "エレベーター", "pdf_path": "uploads/星2エレベーター.pdf", "text_png" : "uploads/エレベーター.png", "context": "エレベーターの内容", "stars": 2},
